"""
Standalone copy of Wasatch/EEPROM.py used to acquire dummy write_buffers for use when replying to ctrl_transfers
"""
...
class EEPROM(object):
    ...
    def __init__(self):
        ...
        self.excitation_nm               = 750.0 # needs to be in range (200, 2500) or Enlighten will reject and set to zero
        self.excitation_nm_float         = 750.0
        self.slit_size_um                = 0
